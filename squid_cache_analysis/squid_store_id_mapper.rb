...
$patterns = {
  ...
  "https*:\/\/ads\.yieldmo\.com\/v002\/t\_ads\/ads\?.*" => "http://ads.yieldmo.com.squid.internal/v002/t_ads/ads?",
  "https*:\/\/weather\.com\/sites\/all\/modules\/glomo\/modules\/gm_footer\/gm_footer\.controller\.js\?.*" => "https://weather.com.squid.internal/sites/all/modules/glomo/modules/gm_footer/gm_footer.controller.js",
  "https*:\/\/trc\.taboola\.com\/aol\-aol\/log\/2\/debug\?.*" => "http://trc.taboola.com.squid.internal/aol-aol/log/2/debug?",
  "https*:\/\/trc\.taboola\.com\/aol\-aol\/trc\/3\/json\?.*" => "http://trc.taboola.com.squid.internal/aol-aol/trc/3/json?",
  "https*:\/\/wa\.and\.co\.uk\/b\/ss\/anddailymailprod\/1\/H\.26\/.*" => "http://wa.and.co.uk.squid.internal/b/ss/anddailymailprod/1/H.26/",
  "https*:\/\/b\.aol\.com\/vanity\/\?.*" => "http://b.aol.com.squid.internal/vanity/?",
  "https*:\/\/b\.aol\.com\/ping\?.*" => "http://b.aol.com.squid.internal/ping?",
  "https*:\/\/amplifypixel\.outbrain\.com\/pixel\?.*" => "https://amplifypixel.outbrain.com.squid.internal/pixel?",
  "http:\/\/adserver\.adtech\.de\/addyn\/3\.0\/327\.0\/[0-9]+\/0\/-1\/ADTECH.*" => "http://adserver.adtech.de.squid.internal/addyn/3.0/327.0/0/0/-1/ADTECH",
  "http:\/\/as\.casalemedia\.com\/cygnus\?.*" => "http://as.casalemedia.com.squid.internal/cygnus?",
  "http:\/\/intermarkets\-d\.openx\.net\/w\/1\.0\/acj\?.*" => "http://intermarkets-d.openx.net.squid.internal/w/1.0/acj?",
  "http:\/\/i\.yldbt\.com\/m\/1f00\/v1\/init\?.*" => "http://i.yldbt.com.squid.internal/m/0/v1/init?",
  "http:\/\/i\.yldbt\.com\/m\/[0-9a-zA-Z]+\/info\.gif\?.*" => "http://i.yldbt.com.squid.internal/m/c289/info.gif",
  "http:\/\/optimized\-by\.rubiconproject\.com\/a\/api\/fastlane\.json\?.*" => "http://optimized-by.rubiconproject.com.squid.internal/a/api/fastlane.json",
  "http:\/\/p\.skimresources\.com\/px\.gif\?.*" => "http://p.skimresources.com.squid.internal/px.gif",
  "http:\/\/px\.dynamicyield\.com\/dpx\?\_.*" => "http://px.dynamicyield.com.squid.internal/dpx?",
  "http:\/\/px\.dynamicyield\.com\/var\?\_.*" => "http://px.dynamicyield.com.squid.internal/var?",
  "https:\/\/[a-zA-Z0-9]+\.cloudfront\.net\/atrk\.gif.*" => "https://d5nxst8fruw4z.cloudfront.net.squid.internal/atrk.gif",
  "http:\/\/s\.effectivemeasure\.net\/d\/6\/p\?.*" => "http://s.effectivemeasure.net.squid.internal/d/6/p",
  "https:\/\/ping\.chartbeat\.net\/ping\/ad\?.*" => "https://ping.chartbeat.net.squid.internal/ping/ad?",
  "https:\/\/p\.typekit\.net\/p\.gif\?.*" => "https://p.typekit.net.squid.internal/p.gif?",
  "http:\/\/apex\.go\.sonobi\.com\/trinity\.js\?.*" => "http://apex.go.sonobi.com.squid.internal/trinity.js?",
  "http:\/\/ade\.clmbtech\.com\/cde\/data\/v4\.htm.*" => "http://ade.clmbtech.com.squid.internal/cde/data/v4.htm?",
  "http:\/\/api\.mixpanel\.com\/track\/\?.*" => "http://api.mixpanel.com.squid.internal/track/?",
  "http:\/\/insight\.adsrvr\.org\/track\/evnt\/\?.*" => "http://insight.adsrvr.org.squid.internal/track/evnt/?",
  "http:\/\/pixel\.wp\.com\/g\.gif\?.*" => "http://pixel.wp.com.squid.internal/g.gif?",
  "https:\/\/cm\.g\.doubleclick\.net\/pixel\?.*" => "https://cm.g.doubleclick.net.squid.internal/pixel?",
  "http:\/\/tags\.tiqcdn\.com\/utag\/tiqapp\/utag\.v\.js\?.*" => "http://tags.tiqcdn.com.squid.internal/utag/tiqapp/utag.v.js?",
  "http:\/\/[a-zA-Z0-9\-]+\.config\.parsely\.com\/config\/.*" => "http://srv-2016-04-09-20.config.parsely.com.squid.internal/config/"
}
