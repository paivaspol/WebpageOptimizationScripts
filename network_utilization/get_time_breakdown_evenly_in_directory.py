...
def find_interval_borders(root_dir, percent_ignoring):
    for path, dirs, filenames in os.walk(root_dir):
        ...
        if os.path.exists(pcap_full_path) and \
            ...
            command = 'python get_time_breakdown_evenly_split_bytes.py {0} {1} {2} {3} --output-dir {4}'.format(pcap_full_path, start_end_time_full_path, total_bytes_full_path, percent_ignoring, path)
