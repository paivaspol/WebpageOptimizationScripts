...
def main(root_dir, output_dir):
    ...
    for page in pages:
        ...
        pool.apply_async(ProcessPageTracingFile, args=(tracing_filename,
            output_filename))
    pool.close()
    pool.join()


def ProcessPageTracingFile(tracing_filename, output_filename):
    '''
    Helper function for processing the tracing file.
    '''
