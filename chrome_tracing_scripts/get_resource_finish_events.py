...
def display_network_events(json_objs):
    ...
    for i in range(0, len(json_objs)):
        ...
        if timeline_event['name'] == RESOURCE_FINISH:
            ...
            if relative_end_time >= relative_start_time:
                print '0.65 {0} {2} {1}'.format(relative_start_time, timeline_event['name'], relative_end_time)
