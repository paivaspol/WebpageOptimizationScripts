...
def main(root_dir):
    ...
    for page in pages:
        ...
        if not (os.path.exists(network_filename)):
            ...
            continue
        request_id_to_encoded_size, request_id_to_type, request_id_to_url = get_page_size_stats(page, network_filename)
...
def get_page_size_stats(page, network_filename):
