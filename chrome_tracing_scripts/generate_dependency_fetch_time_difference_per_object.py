    ...
    with open(output_filename, 'wb') as output_file:
        ...
        for url, times in sorted_data:
            ...
            try:
                ...
                pass
        try:
            print '{0} {1}'.format(page, numpy.average(diffs))
        except:
            pass
        ...
        for raw_line in input_file:
            ...
            if network_event[constants.METHOD] == constants.NET_REQUEST_WILL_BE_SENT:
                ...
                if url in dependencies and url not in seen_urls:
                    ...
                    seen_urls.add(url)
                    request_id_to_start_ts[request_id] = float(network_event[constants.PARAMS][constants.TIMESTAMP])
                ...
                if request_id in request_id_to_url:
                    ...
                    url_fetch_time = timestamp - request_id_to_start_ts[request_id]
