...
directories=( /Users/vaspol/Documents/research/MobileWebPageOptimization/results/vroom_sigcomm_results/raw_data/main_result/combined_news_sports_push_and_hints_fixed_iframe_parent_01_21 /Users/vaspol/Documents/research/MobileWebPageOptimization/results/vroom_sigcomm_results/raw_data/main_result/baseline_01_14_combined_news_sports_close_tab_after_load )
...
target_resource_dirs=( /Users/vaspol/Documents/research/MobileWebPageOptimization/results/vroom_debugging/network_utilizations/baseline_12_22/dependencies/dependency_list_sorted_by_execution_time )
...
do
  ...
  python find_page_resources.py ${resource_root_dir} ${target_resource_dirs[0]}
  ...
  for mode in ${important_all[@]}; do
    for target_resource_dir in ${target_resource_dirs[@]}; do
      ...
      if [[ ${mode} == "important" ]]; then
        ...
        echo "python find_all_dependencies_finished_loading_from_network_events.py ${resource_root_dir} ${target_resource_dir} --output-finish-times ${client_side_resource_finish_load_time_dir} --page-list ${page_list} --only-important > ${client_side_fetch_time_output}"
        echo ""
        ...
        # Find the resource finish fetch time on the client-side.
        echo "python find_all_dependencies_finished_loading_from_network_events.py ${resource_root_dir} ${target_resource_dir} --output-finish-times ${client_side_resource_finish_load_time_dir} --page-list ${page_list} > ${client_side_fetch_time_output}"
        echo ""
