...
def main(pages_file, num_repetitions, output_dir):
...
def load_page(raw_line, run_index, output_dir):
...
if __name__ == '__main__':
    ...
    main(args.pages_file, args.num_repetitions, args.output_dir)
