...
python find_resource_intersection.py ${root_dir} ${page_list_filename} ${iterations} ${output_dir}/resource_intersection
...
python find_dependency_ordering_from_execution_time.py ${root_dir} ${page_list_filename} ${output_dir}/dependency_list_sorted_by_request_time 4 ${output_dir}/dependency_list_sorted_by_execution_time
