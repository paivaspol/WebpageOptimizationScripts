...
def generate_file_from_dependency_tree_object(dependency_tree_object, \
    ...
    current_node_dependency_type = dependency_node['type']
    current_node_url = dependency_node['url']
    if common_module.escape_url(current_node_url) == common_module.escape_url(page) or \
        (current_node_dependency_type != 'Document'):
